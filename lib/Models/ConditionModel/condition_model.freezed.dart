...
/// @nodoc
@JsonSerializable()
class _$_ConditionModel extends _ConditionModel {
  _$_ConditionModel(this.text, this.icon, this.code) : super._();
...
abstract class _ConditionModel extends ConditionModel {
  factory _ConditionModel(
          final String? text, final String? icon, final int? code) =
      _$_ConditionModel;
  _ConditionModel._() : super._();
